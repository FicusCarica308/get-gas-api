...
## Routes:
* /specs/:type/:make/:model/:year/:cylinders? - Returns MPG data for a vehicle using an external API.
* /stations/:latitude/:longitude/ - Returns the GPS Coordinates of gas stations ranked closest to farthest using the given longitude and latitude.
